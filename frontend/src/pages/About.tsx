    ...
    <section className="gradient-hero py-20">
      <div className="container">
        ...
        <motion.p {...fadeUp} transition={{ delay: 0.2 }} className="mt-4 max-w-2xl text-lg text-primary-foreground/80">
          MotoHub is a trusted name in car and bike services. We are passionate about keeping your vehicles running at peak performance.
        </motion.p>
      </div>
    </section>
    ...
    <section className="py-20">
      <div className="container grid gap-12 lg:grid-cols-2">
        <motion.div {...fadeUp}>
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed">
            Founded with a vision to transform the automotive service industry, MotoHub combines cutting-edge technology with skilled craftsmanship to deliver exceptional results every time.
          </p>
        </motion.div>
